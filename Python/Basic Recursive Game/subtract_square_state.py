...
class SubtractSquareState(GameState):
    ...
    def __str__(self):
        ...
        Return a convenient string representation of
        SubtractSquareState (self).
    ...
    def possible_next_moves(self):
        ...
        >>> L2 = [SubtractSquareMove(1), SubtractSquareMove(4), \
SubtractSquareMove(9), SubtractSquareMove(16)]
